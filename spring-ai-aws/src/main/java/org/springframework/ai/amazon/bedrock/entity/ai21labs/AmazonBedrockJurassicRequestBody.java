...
public record AmazonBedrockJurassicRequestBody(String prompt, Integer maxTokens, Double temperature, Double topP,
		List<String> stopSequences, Penalty countPenalty, Penalty presencePenalty, Penalty frequencyPenalty) {
